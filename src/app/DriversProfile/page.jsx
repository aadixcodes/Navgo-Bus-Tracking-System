...
const DriversProfile = () => {
  ...
  const [newDriver, setNewDriver] = useState({ name: '', age: '', busNo: '', routeCity: '' });
    ...
    const fetchDrivers = async () => {
      ...
      try {
        const response = await new Promise(resolve => setTimeout(() => resolve([
          { id: 1, name: 'John Doe', age: 35, busNo: '101', routeCity: 'Indore' },
          { id: 2, name: 'Jane Smith', age: 42, busNo: '202', routeCity: 'Ujjain' },
          { id: 3, name: 'Mike Johnson', age: 38, busNo: '303', routeCity: 'Dewas' },
        ]), 1500));
  ...
  const handleFormSubmit = (event) => {
    ...
    setNewDriver({ name: '', age: '', busNo: '', routeCity: '' });
  };
